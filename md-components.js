(function() {
  ...
  var root_1$f = /* @__PURE__ */ from_html(`<div class="badge badge-error badge-xl svelte-o0vjex">Wrong branch</div>`);
  ...
  var parse = function parse2(text2, reviver) {
    ...
    if (typeof reviver === "function") {
      return internalize({ "": root$C }, "", reviver);
    }
    return root$C;
  };
  ...
  var lib = JSON5;
  var root_1$e = /* @__PURE__ */ from_html(`<iframe frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen="" class="svelte-bvj577"></iframe>`);
  var root$B = /* @__PURE__ */ from_html(`<div class="svelte-bvj577"></div>`);
  const $$css$x = {
    hash: "svelte-bvj577",
    code: "div.svelte-bvj577 {display:flex;flex-wrap:wrap;gap:16px;margin-top:20px}iframe.svelte-bvj577 {display:inline-block;}"
  };
  function Video_list($$anchor, $$props) {
    push$1($$props, true);
    append_styles$1($$anchor, $$css$x);
    const iframe = ($$anchor2, src = noop, title = noop) => {
      var iframe_1 = root_1$e();
      template_effect(() => {
        set_attribute(iframe_1, "width", width());
        set_attribute(iframe_1, "height", height());
        set_attribute(iframe_1, "src", src());
        set_attribute(iframe_1, "title", title());
      });
      append($$anchor2, iframe_1);
    };
    let width = prop($$props, "width", 7), height = prop($$props, "height", 7), list = prop($$props, "list", 7);
    let videos = lib.parse(list());
    ...
    var div = root$B();
    each(div, 21, () => videos, index, ($$anchor2, video) => {
      const src = /* @__PURE__ */ user_derived(() => youtube(get$1(video)[0]));
      const title = /* @__PURE__ */ user_derived(() => get$1(video)[1]);
      iframe($$anchor2, () => get$1(src), () => get$1(title));
    });
    reset(div);
    append($$anchor, div);
    return pop$1($$exports);
  }
  customElements.define("video-list", create_custom_element(Video_list, { width: {}, height: {}, list: {} }, [], [], false));
  ...
  create_custom_element(HtmlContent, { phaseNo: {}, content: {}, phaseSelector: {} }, [], [], true);
  ...
  function buildDrills(args) {
    ...
    function parseDrills() {
      ...
      function makeSrc(id, content, html2, _$) {
        ...
        let phaseSelectorRegex = /\$!html:w([+|-])h([+|-])r([+|-])/;
        function parsePhaseSelector() {
          let match = phaseSelectorRegex.exec(line2());
          if (!match) return { wrong: true, hint: true, right: true };
          return {
            wrong: match[1] === "+",
            hint: match[2] === "+",
            right: match[3] === "+"
      ...
      function makeDrill(id, src) {
        ...
        function addHtmlContent(phaseNo, content, phaseSelector) {
          add("html-content", { phaseNo, content, phaseSelector });
        }
        return {
          id,
          tokens,
  ...
  function Code_drills($$anchor, $$props) {
    ...
    each(node_9, 17, () => get$1(drills), index, ($$anchor2, drill2, no, $$array) => {
      ...
      template_effect(
        ($0) => {
          set_attribute(div_4, "data-tip", get$1(drill2).id);
          classes_2 = set_class(button_5, 1, "exact btn btn-xs btn-primary  svelte-1q1houn", null, classes_2, $0);
        },
  ...
  var root_1$7 = /* @__PURE__ */ from_html(`<iframe class="svelte-1qzm2j1"></iframe>`);
  var root_2$4 = /* @__PURE__ */ from_html(`<span class="error svelte-1qzm2j1">\`No drills are found (failed to parse JSON drills?)\`<br/> </span>`);
  var root$9 = /* @__PURE__ */ from_html(`<div class="grid svelte-1qzm2j1"><!> <!></div>`);
  const $$css$9 = {
    hash: "svelte-1qzm2j1",
    code: "\r\n    /*todo: make iframe increased */.grid.svelte-1qzm2j1 {display:grid;grid-template-columns:repeat(auto-fit, minmax(var(--drill-width), 1fr));gap:16px;justify-content:space-evenly;margin:8px;}iframe.svelte-1qzm2j1 {width:100%;height:var(--drill-height);border-radius:8px;overflow:hidden;box-shadow:0 4px 16px rgba(0, 0, 0, 0.25);transition:outline 0.1s;}iframe.svelte-1qzm2j1:hover {outline:3px solid blue;}.error.svelte-1qzm2j1 {background-color:yellow;color:red;font-weight:bold;}"
  };
  function Drills_page($$anchor, $$props) {
    push$1($$props, true);
  ...
  addToMyRoot(document.head, ["tailwind", "daisy-ui", "mathjax"]);
